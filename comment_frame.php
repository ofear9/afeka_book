...
<style type="text/css">
	*{
	...
	$user_query = mysqli_query($con,"SELECT added_by, user_to 
	...
	<!--Load comments -->
	<?php
	$get_commnets = mysqli_query($con,"SELECT * FROM comments WHERE post_id='$post_id' ORDER BY id ASC");
	$count = mysqli_num_rows($get_commnets);


	if($count!=0){
		while($commnet = mysqli_fetch_array($get_commnets)){
			...
			<div class="comment_section">
		        <a href="<?php echo $posted_by?>" target="_parent"><img src="<?php echo $user_obj->getProfilePic();?>" 
		        														title="<?php echo $user_obj->getFirstAndLastName();?>"   										style="float:left;" height="30"></a>
